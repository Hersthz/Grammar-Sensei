...
assert.strictEqual(summary.total, 222, "Phase 8 DB count should stay stable unless content is intentionally changed");
...
console.log(`Analyzer tests passed (${cases.length + 8} checks).`);
